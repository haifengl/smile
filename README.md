...
SMILE (Statistical Machine Intelligence and Learning Engine) is a pure Java library of various state-of-are machine learning algorithms. SMILE is self contained and depends only on Java standard library.
