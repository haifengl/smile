...
libraryDependencies ++= {
  ...
  Seq(
    ...
    "org.apache.parquet" % "parquet-hadoop" % "1.13.0" % Provided exclude("org.slf4j", "slf4j-log4j12"),
    "org.apache.hadoop" % "hadoop-common" % "3.3.5" % Provided exclude("org.slf4j", "slf4j-log4j12"),
