...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, lapacke_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, lapacke_h.C_SHORT).withName("__old_x"),
        lapacke_h.C_SHORT.withName("__c"),
        lapacke_h.C_SHORT.withName("__init"),
        lapacke_h.C_LONG_LONG.withName("__a")
