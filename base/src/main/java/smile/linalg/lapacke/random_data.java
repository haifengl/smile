...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        lapacke_h.C_POINTER.withName("fptr"),
        lapacke_h.C_POINTER.withName("rptr"),
        lapacke_h.C_POINTER.withName("state"),
        lapacke_h.C_INT.withName("rand_type"),
        lapacke_h.C_INT.withName("rand_deg"),
        lapacke_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        lapacke_h.C_POINTER.withName("end_ptr")
