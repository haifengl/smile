...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cblas_openblas_h.C_INT.withName("__readers"),
        cblas_openblas_h.C_INT.withName("__writers"),
        cblas_openblas_h.C_INT.withName("__wrphase_futex"),
        cblas_openblas_h.C_INT.withName("__writers_futex"),
        cblas_openblas_h.C_INT.withName("__pad3"),
        cblas_openblas_h.C_INT.withName("__pad4"),
        cblas_openblas_h.C_INT.withName("__cur_writer"),
        cblas_openblas_h.C_INT.withName("__shared"),
        cblas_openblas_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, cblas_openblas_h.C_CHAR).withName("__pad1"),
        cblas_openblas_h.C_LONG.withName("__pad2"),
        cblas_openblas_h.C_INT.withName("__flags"),
