...
public class OrtSyncStreamImpl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        onnxruntime_c_api_h.C_POINTER.withName("GetHandle"),
        onnxruntime_c_api_h.C_POINTER.withName("CreateNotification"),
        onnxruntime_c_api_h.C_POINTER.withName("Flush"),
        onnxruntime_c_api_h.C_POINTER.withName("OnSessionRunEnd")
    ...
    public final static class GetHandle {
        ...
        private static final MethodHandle UP$MH = onnxruntime_c_api_h.upcallHandle(GetHandle.Function.class, "apply", $DESC);
     ...
     * }
     */
    public final static class CreateNotification {
        ...
        private static final MethodHandle UP$MH = onnxruntime_c_api_h.upcallHandle(CreateNotification.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(CreateNotification.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final long CreateNotification$OFFSET = $LAYOUT.byteOffset(groupElement("CreateNotification"));
    ...
    public final static class Flush {
        ...
        private static final MethodHandle UP$MH = onnxruntime_c_api_h.upcallHandle(Flush.Function.class, "apply", $DESC);
     ...
     * }
     */
    public final static class OnSessionRunEnd {

        private OnSessionRunEnd() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = onnxruntime_c_api_h.upcallHandle(OnSessionRunEnd.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(OnSessionRunEnd.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final long OnSessionRunEnd$OFFSET = $LAYOUT.byteOffset(groupElement("OnSessionRunEnd"));
