...
public class ICA implements Projection<double[]>, Serializable {
	...
	public enum NegEntropyFunc {
		/** This Negative Entropy function is described as
		 *  a "good general-purpose contrast 
         *  function" in the original paper, 
         *  and the default method used.*/
		LOGCOSH,
		/** This is function according to the paper may be better than {@link #LOGCOSH} 
		 *  when the independent components are highly super-Gaussian, or when 
