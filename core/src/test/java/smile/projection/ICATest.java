...
public class ICATest {
    ...
    public void testWithMixedSignal() {
        ...
        try {
            AttributeDataset mixed = parser.parse(smile.data.parser.IOUtils.getTestDataFile("projection/mixed-signal/test_ica_X.csv"));
...
//            BufferedWriter bw = new BufferedWriter(new FileWriter("test_ica_reconstruct.csv"));  
//            for(int i = 0;i < size;i++) {
