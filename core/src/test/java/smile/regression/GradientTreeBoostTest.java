...
public class GradientTreeBoostTest {
    ...
    static Abalone abalone;
    static Ailerons ailerons;
    static AutoMPG autoMPG;
    static Bank32nh bank32nh;
    static BostonHousing bostonHousing;
    static CalHousing calHousing;
    static CPU cpu;
    static Kin8nm kin8nm;
    static Planes2D planes;
    static Puma8NH puma;
    ...
    public void testLongley() throws Exception {
        ...
        assertEquals(3.5878, metrics.rmse(), 1E-4);
    ...
    public void testShap() {
        ...
        String[] expected = {"CHAS", "ZN", "RAD", "INDUS", "B", "TAX", "AGE", "PTRATIO", "CRIM", "NOX", "DIS", "RM", "LSTAT"};
