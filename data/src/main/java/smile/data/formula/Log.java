 ...
 * @author Haifeng Li
 */
public class Log<T> implements Factor<T, Double> {
     ...
     */
    public Log(Factor<T, Double> factor) {
        this.child = factor;
    }
     ...
     * Constructor.
     *
     * @param column the variable that log function is applied to.
     */
    public Log(String column) {
