...
ST_Tensor smile_tensor_pow_s  (ST_Tensor t, ST_Scalar e)                       { MAKE_TENSOR(t->t.float_pow(e->s)); }
...
void smile_tensor_pow_s_    (ST_Tensor t, ST_Scalar e)                  { if (t&&e) t->t.float_pow_(e->s); }
