...
libraryDependencies += "org.apache.parquet" % "parquet-hadoop" % "1.10.1" exclude("org.slf4j", "slf4j-log4j12")

// required by parquet
libraryDependencies += "org.apache.hadoop" % "hadoop-common" % "3.2.1" exclude("org.slf4j", "slf4j-log4j12")

libraryDependencies += "org.apache.avro" % "avro" % "1.9.1" exclude("org.slf4j", "slf4j-log4j12")

libraryDependencies += "com.epam" % "parso" % "2.0.11"

libraryDependencies += "org.apache.commons" % "commons-csv" % "1.7"

libraryDependencies += "org.xerial" % "sqlite-jdbc" % "3.28.0" % Test
