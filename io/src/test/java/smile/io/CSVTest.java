...
public class CSVTest {
    ...
    public void testDiabetes() throws Exception {
        ...
        assertEquals(442, diabetes.nrow());
    ...
    public void testAbalone() throws Exception {
        ...
        assertEquals(3133, abalone.nrow());
    ...
    public void testUserdata() throws Exception {
        ...
        CSVFormat format = CSVFormat.DEFAULT.withFirstRecordAsHeader();
        CSV csv = new CSV(format);
        DataFrame df = csv.read(Paths.getTestData("userdata/userdata1.csv"));
