...
languages. `smile-json` is a lightweight, clean and efficient JSON
implementation in Scala. It supports the following features:

- A simple mutable model of the JSON objects and arrays
- An efficient JSON parser
- Compact or pretty JSON-to-string printing
- Besides standard JSON types, it also supports additional types such as date, int, long, double,
