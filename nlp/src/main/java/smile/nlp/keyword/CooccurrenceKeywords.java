 ...
 * information. The algorithm was proposed by Matsuo &amp; Ishizuka (2004):
 * <em>Keyword Extraction from a Single Document using Word Co-occurrence
 * Statistical Information</em>, AAAI 2004. It consists of six steps:
 * <ol>
 ...
 * @author Haifeng Li
 */
public final class CooccurrenceKeywords {
     ...
     * value.
     */
    private static final double CLUSTERING_THRESHOLD = 0.25;

    /** Utility class — no instances. */
    private CooccurrenceKeywords() {}

    /**
     * Returns the top 10 keywords extracted from the given document.
     *
     * @param text a single, non-blank document.
    ...
    /**
     * Returns the top {@code maxNumKeywords} keywords extracted from the
     * given document.
     *
     * @param text           a single, non-blank document.
    ...
    public static List<NGram> of(String text, int maxNumKeywords) {
        ...
        for (NGram[] ngrams : NGram.of(sentences, MAX_NGRAM_SIZE, MIN_NGRAM_FREQ)) {
