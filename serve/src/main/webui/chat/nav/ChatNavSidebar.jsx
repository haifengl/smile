    ...
    <nav className="chat-nav" aria-label="Chat navigation">
      {showSettings && loggedIn ? (
        ...
        <>
          ...
          <div className="chat-nav__section chat-nav__account">
            {authLoading ? (
          ...
          <div
            className={`chat-nav__section chat-nav__footer ${loggedIn ? '' : 'chat-nav__section--disabled'}`}
          >
            <button
              type="button"
              className="chat-nav__settings"
              disabled={!loggedIn}
