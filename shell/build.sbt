...
batScriptExtraDefines  += """set _JAVA_OPTS=%_JAVA_OPTS% -Dsmile.home=%SMILE_HOME% -Dscala.repl.autoruncode=%SMILE_HOME%\\init.scala -Dconfig.file=%SMILE_HOME%\\..\\conf\\smile.conf"""
