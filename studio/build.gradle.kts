...
dependencies {
    ...
    implementation("org.apache.maven.resolver:maven-resolver-supplier-mvn4:2.0.17")
    ...
    implementation("com.google.code.gson:gson:2.14.0") // evict older version used by serpapi
    // local packages
