...
public class OpenAI extends LLM {
    ...
    private String callTool(ChatCompletionMessageFunctionToolCall.Function tool,
        ...
        return switch (tool.name()) {
            ...
            case "ApplyPatch" -> tool.arguments(ApplyPatch.class).run(conversation, handler);
            ...
            case "EnterPlanMode" -> tool.arguments(EnterPlanMode.class).run(conversation, handler);
            case "ExitPlanMode" -> tool.arguments(ExitPlanMode.class).run(conversation, handler);
            case "TodoWrite" -> tool.arguments(TodoWrite.class).run(conversation, handler);
            case "AskUserQuestion" -> tool.arguments(AskUserQuestion.class).run(conversation, handler);
