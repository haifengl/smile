...
""")
public class EnterPlanMode implements Tool {
    @JsonProperty(required = true)
    @JsonPropertyDescription("A brief explanation for entering plan mode, such as \"Starting a complex feature implementation\" or describing the bug to be fixed.")
    ...
    /**
     * The specification for EnterPlanMode tool.
     * @return the tool specification.
     */
    public static Tool.Spec spec() {
        return new Tool.Spec(EnterPlanMode.class, List.of());
    }
}
